    ...
    <ul class="list-unstyled">
        ...
        <li class="dropdown pc-h-item header-user-profile">
            <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                ...
                <img src="{{ asset('AdminTemplate/assets/images/user/avatar-2.jpg') }}" alt="user-image"
                    class="user-avtar" />
            </a>
                ...
                <div class="dropdown-body">
                    <div class="profile-notification-scroll position-relative"
                        ...
                        <div class="d-flex mb-1">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('AdminTemplate/assets/images/user/avatar-2.jpg') }}"
                                    alt="user-image" class="user-avtar wid-35" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1">Oktaryan Hugo 🖖</h6>
                                <span>111201912355@mhs.dinus.ac.id</span>
                            </div>
                        </div>
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="user-group">
                                <img src="{{ asset('AdminTemplate/assets/images/user/avatar-1.jpg') }}"
                        ...
                        <div class="card border-0 shadow-none drp-upgrade-card mb-0"
                            style="background-image: url({{ asset('AdminTemplate/assets/images/layout/img-profile-card.jpg') }})">
                            <div class="card-body">
                                <div class="user-group">
                                    <img src="{{ asset('AdminTemplate/assets/images/user/avatar-1.jpg') }}"
                                        alt="user-image" class="avtar" />
                                    <img src="{{ asset('AdminTemplate/assets/images/user/avatar-2.jpg') }}"
                                        alt="user-image" class="avtar" />
                                    <img src="{{ asset('AdminTemplate/assets/images/user/avatar-3.jpg') }}"
                                        alt="user-image" class="avtar" />
                                    <img src="{{ asset('AdminTemplate/assets/images/user/avatar-4.jpg') }}"
                                        alt="user-image" class="avtar" />
                                    <img src="{{ asset('AdminTemplate/assets/images/user/avatar-5.jpg') }}"
                                        alt="user-image" class="avtar" />
